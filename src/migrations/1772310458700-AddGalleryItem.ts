// src/migrations/1772310458700-AddGalleryItem.ts

import { MigrationInterface, QueryRunner } from 'typeorm';

export class AddGalleryItem1772310458700 implements MigrationInterface {
  name = 'AddGalleryItem1772310458700';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_gallery_folder" ON "gallery_item" ("folder")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_gallery_created" ON "gallery_item" ("created_at" DESC)`
    );
  }
